...
function resolveTodayDateValue(): string {
...
function isValidBirthValue(value: string): boolean {
  // 미입력은 허용합니다.
  if (value.trim() === "") {
    return true;
  }
...
function isValidPhoneNumberValue(value: string): boolean {
  // 미입력은 허용합니다.
  if (value.trim() === "") {
    return true;
  }
...
function resolveJoinDeviceType(): ShopGoogleJoinDeviceType {
