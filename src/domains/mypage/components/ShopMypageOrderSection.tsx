...
import type { ShopMypageOrderPageResponse } from "@/domains/mypage/types";
import {
  createShopMypageOrderStatusCardList,
  formatShopMypageOrderCount,
  type ShopMypageOrderStatusCard,
...
export default function ShopMypageOrderSection({ orderPageData, initialRange }: ShopMypageOrderSectionProps) {
  ...
  const orderStatusCardList: ShopMypageOrderStatusCard[] = createShopMypageOrderStatusCardList(orderPageData.statusSummary);
      ...
      <header className={styles.orderHeader}>
        <div>
          ...
          <p className={styles.orderDescription}>
            {orderPageData.startDate} ~ {orderPageData.endDate} 주문번호 {formatShopMypageOrderCount(orderPageData.orderCount)}
            건
          </p>
        </div>
      </header>
      ...
      <section className={styles.summarySection}>
        {orderStatusCardList.map((statusCard) => (
          <article key={statusCard.key} className={styles.summaryCard}>
            ...
            <p className={styles.summaryCount}>{formatShopMypageOrderCount(statusCard.count)}건</p>
          </article>
        ))}
      </section>

      <ShopMypageOrderCardList orderList={orderPageData.orderList} />
